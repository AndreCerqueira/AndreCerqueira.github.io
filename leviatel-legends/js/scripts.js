...
1;; ;Akame;;{keyword:On death:}  Deals 3 damage to the enemy castle.;;Layouts/neutral.png;Characters/2-Akame.png;Numbers/2.png;Numbers/3.png;Numbers/4.png;Numbers/3.png;Rarities/legendary.png;;
1;; ;Amanda;;Front allies in the same column have{Text-Icons/attack.png}.;;Layouts/defensive.png;Characters/3-Amanda.png;Numbers/2.png;Numbers/0.png;Numbers/1.png;Numbers/1.png;Rarities/rare.png;;
...
1;;;Bibian;;{keyword:On entering:} Grants and to allies in the front area.;;Layouts/neutral.png;Characters/7-Bibian.png;Numbers/1.png;Numbers/1.png;Numbers/1.png;Numbers/1.png;Rarities/common.png;;
...
1;;;Test Subject;;{keyword:On entering an area:} Merge with test subjects in the same area.;;Layouts/offensive.png;Characters/10-Cobaia.png;Numbers/0.png;Numbers/0.png;Numbers/1.png;Numbers/1.png;;;
1;;;Deep Rooted;;Allied beasts in the area gain at the end of the turn.;;Layouts/structure.png;Characters/11-DeepRooted.png;Numbers/2.png;Numbers/2.png;Numbers/2.png;Numbers/4.png;Rarities/epic.png;Tribes/structure-tribe.png;Nature
...
1;;;The Fallen One;{fontSize:11px};{keyword:Choose a valid spawning area.} Choose and summon a character from the graveyard pile.;;Layouts/spell.png;Characters/13-Fallen.png;Numbers/3.png;Numbers/1.png; ; ;Rarities/legendary.png;Tribes/spell-tribe.png;Curse
...
1;;;Jean François;{fontSize:11px};After another Pirate attacks, this card gains {Text-Icons/defense.png}.;;Layouts/defensive.png;Characters/15-Jean.png;Numbers/2.png;Numbers/1.png;Numbers/2.png;Numbers/2.png;Rarities/common.png;Tribes/defensive-tribe.png;Pirate
...
1;;;Lírio;;Enemies on entering the right and left area start combat with this character first.;;Layouts/defensive.png;Characters/17-Lirio.png;Numbers/2.png;Numbers/3.png;Numbers/3.png;Numbers/5.png;Rarities/epic.png;;
...
1;;;Marco;;Enemies on entering the front area take damage equal to this character attack.;;Layouts/neutral.png;Characters/19-Marco_the_pirate.png;Numbers/3.png;Numbers/0.png;Numbers/1.png;Numbers/2.png;Rarities/rare.png;Tribes/neutral-tribe.png;Pirate
...
1;;;Violence;;{keyword:Choose an ally.} Whenever he attacks, gain {Text-Icons/attack.png} at the end.;;Layouts/spell.png;Characters/24-violence.png;Numbers/1.png;Numbers/1.png; ; ;Rarities/rare.png;Tribes/spell-tribe.png;Curse
...
1;;;Raul;;{keyword:On entering:} Gain {Text-Icons/coin.png}.;;Layouts/neutral.png;Characters/26-Raul.png;Numbers/1.png;Numbers/0.png;Numbers/1.png;Numbers/1.png;Rarities/epic.png;;
...
1;;;Ruby;;{keyword:At the end of your turn:} Grants {Text-Icons/defense.png} to an adjacent character.;;Layouts/defensive.png;Characters/28-Ruby.png;Numbers/2.png;Numbers/2.png;Numbers/2.png;Numbers/2.png;Rarities/rare.png;;
...
1;;;Vengeful Block;{fontSize:10px};{keyword:Choose a character.} This turn, the first lethal damage reduces it to 1 Health instead of dying.;;Layouts/spell.png;Characters/34-VengefullBlock.png;Numbers/2.png;; ; ;Rarities/epic.png;;
1;;;Yasmin;;{keyword: On entering:} Grants {Text-Icons/defense.png} to all allies in the defensive row.;;Layouts/defensive.png;Characters/35-Yasmin.png;Numbers/2.png;Numbers/1.png;;Numbers/3.png;Rarities/rare.png;;
...
1;;;Energy;;Gain {Text-Icons/energy.png} this turn. Doesn't occupy hand space.;;Layouts/spell.png;Characters/37-Energy.png;;; ; ;;;
...
1;;;Cannonball;;Deals 2 damage to a Structure. If destroyed, gain {Text-Icons/coin.png}.;;Layouts/spell.png;Characters/40-Cannonball.png;Numbers/0.png;Numbers/0.png; ; ;Rarities/common.png;;
...
1;;;Pinho;;{keyword:In center:} Other allied Beasts gain {Text-Icons/attack.png}. Allied Beasts in Nature gain an additional {Text-Icons/attack.png}.;;Layouts/defensive.png;Characters/42-Pinho.png;Numbers/2.png;Numbers/0.png;Numbers/1.png;Numbers/1.png;Rarities/common.png;Tribes/defensive-tribe.png;Beast
1;;;Pum;;When attacking grants {Text-Icons/attack.png} to all allied beasts this turn. {keyword:In Nature:} Grants an      additional {Text-Icons/attack.png}.;;Layouts/neutral.png;Characters/43-Pum.png;Numbers/3.png;;Numbers/2.png;Numbers/3.png;Rarities/rare.png;Tribes/neutral-tribe.png;Beast
1;;;Blue Slime;;{keyword:On entering:} Summon a green slime in the area.;;Layouts/neutral.png;Characters/44-Blue_slime.png;Numbers/2.png;Numbers/0.png;Numbers/2.png;Numbers/1.png;Rarities/common.png;;
1;;;Green Slime;; ;;Layouts/neutral.png;Characters/45-Green_slime.png;Numbers/0.png;Numbers/0.png;Numbers/1.png;Numbers/1.png;;;
1;;;Vespula;;{keyword:On death:} Summon a field of flowers in the area.;;Layouts/defensive.png;Characters/46-Vespula.png;Numbers/3.png;Numbers/0.png;;Numbers/2.png;Rarities/common.png;Tribes/defensive-tribe.png;Beast
...
1;;;Ant;;{keyword:On summoning a Beast:} This card is summoned from the hand to the same area.;;Layouts/offensive.png;Characters/49-ant.png;Numbers/2.png;Numbers/0.png;Numbers/1.png;Numbers/1.png;Rarities/rare.png;Tribes/offensive-tribe.png;Beast
...
1;;;Tempest;;Does not deal damage to the castle.;;Layouts/neutral.png;Characters/54-Thunder.png;Numbers/0.png;Numbers/0.png;Numbers/0.png;Numbers/3.png;;;Elemental
...
1;;;Royal Fortune;;{keyword:Maritime. Rechargeable.} Summons a buccaneer in the area, or successively forward if full.;;Layouts/structure.png;Characters/59-Royal_fortune.png;Numbers/3.png;Numbers/1.png;;Numbers/3.png;Rarities/rare.png;Tribes/structure-tribe.png;Vehicle
...
1;;;Buccaneer;; ;;Layouts/offensive.png;Characters/61-Buccaneer.png;Numbers/0.png;Numbers/0.png;;Numbers/1.png;;Tribes/offensive-tribe.png;Pirate
