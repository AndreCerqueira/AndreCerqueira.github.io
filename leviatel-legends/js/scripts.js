...
1;; ;Amanda;;{keyword:Protectable.} Front allies in the same column gain {Text-Icons/attack-temp.png}.;;Layouts/defensive.png;Characters/3-Amanda.png;Numbers/2.png;Numbers/0.png;Numbers/1.png;Numbers/1.png;Rarities/rare.png;;
...
1;;;Pinho;;{keyword:Protectable.} {keyword:In center:} Other allied Beasts gain {Text-Icons/attack-temp.png}.;;Layouts/defensive.png;Characters/42-Pinho.png;Numbers/2.png;Numbers/0.png;Numbers/1.png;Numbers/1.png;Rarities/common.png;Tribes/defensive-tribe.png;Beast
1;;;Pum;;When attacking grants {Text-Icons/attack-temp.png} to all allied beasts this turn.;;Layouts/neutral.png;Characters/43-Pum.png;Numbers/3.png;;Numbers/2.png;Numbers/3.png;Rarities/common.png;Tribes/neutral-tribe.png;Beast
...
1;;;Vespula Hive;{fontSize:11px};{keyword:On death:} Summon a Vespula in the area.;;Layouts/defensive.png;Characters/71-Vespula_Hive.png;Numbers/2.png;Numbers/1.png;Numbers/1.png;Numbers/3.png;Rarities/rare.png;;
...
1;;;Vitorius;;Only possible to invest in center. {keyword:Invest} {Text-Icons/coin.png}{keyword::} All allied Pirates get {Text-Icons/attack-temp.png}{Text-Icons/attack-temp.png}. for 1 round;{top:238px};Layouts/defensive.png;Characters/56-Victorius.png;Numbers/2.png;Numbers/2.png;Numbers/1.png;Numbers/4.png;Rarities/common.png;Tribes/defensive-tribe.png;Pirate
...
1;;;Samuel Roshvire;{fontSize:9px};{keyword:When an Undead enter the graveyard:} Summon a remains forward, or successively forward if full.;;Layouts/defensive.png;Characters/63-Roshvire.png;Numbers/0.png;Numbers/2.png;Numbers/2.png;Numbers/4.png;Rarities/legendary.png;;
